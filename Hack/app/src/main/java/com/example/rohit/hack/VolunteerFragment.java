...
public class VolunteerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.volunteer_fragment_layout,null);
        ...
        if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER) && !ProfileActivity.searching) {
            ...
            recyclerView = (RecyclerView) rootView.findViewById(R.id.volunteer_recycler_view);
            recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
            recyclerViewAdapter = new RecyclerViewAdapter(posts, getActivity());
            recyclerView.setAdapter(recyclerViewAdapter);
            recyclerViewAdapter.notifyDataSetChanged();

            DatabaseReference amenitiesDB = FirebaseDatabase.getInstance().getReference("Volunteer");
        ...
        if(ProfileActivity.searching) {
            ...
            amenitiesDB.orderByKey().addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    ...
                    if (AmenitiesFragment.currentUserLocation.distanceTo(postLocation) / 1000 < ProfileActivity.radiusOfSearch) {
                        p.distancetoPost = AmenitiesFragment.currentUserLocation.distanceTo(postLocation) / 1000.0;
                        posts.add(p);
                    }
                    recyclerViewAdapter.notifyDataSetChanged();
